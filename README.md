...
This project uses Bootstrap with Sass for styling.
...
| `npx sass styles.scss styles.css` | Compile Sass |
| `npx sass --watch styles.scss styles.css` | Auto-compile on file changes |
